...
const EncryptButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden rounded-lg border-[1px] border-indigo-300 px-2 py-2 font-mono font-medium uppercase text-slate-300 transition-colors hover:text-indigo-300"
    >
      ...
      <header className="sticky shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md top-0 p-3 flex justify-between max-w-8xl mx-auto z-20 items-center  xl:items-center">
        ...
        >
          <h1 className="text-white flex justify-center items-center">
            <span>
              <Image src="/Sgfl.png" alt="logo" width={30} height={30}></Image>
            </span>{" "}
            Vision
          </h1>
        </motion.div>
